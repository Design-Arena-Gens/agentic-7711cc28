      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">AI POS Platform</h1>
            <p className="text-gray-600 mt-2">Business Intelligence & Point of Sale</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-primary-600 to-primary-700 text-white py-3 rounded-lg font-semibold hover:from-primary-700 hover:to-primary-800 transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Supports Restaurant, Retail & Multi-Business POS
            </p>
          </div>
        </div>
      </div>
